...
control_user_led1
	...
	CMP R0, #1      // check if state is on
	BEQ LEDon       // Jump if on
	LEDoff:         // Fall through if off
          STR GPIOA_BIT_5, [GPIOA_BASE,GPIOA_ODR]  // set bit 5 to 0
          MOV R0, R1   // put duration into R0
          BL delay     // call delay function
	LEDon:         // Location for LED on
          STR GPIOA_BIT_5, GPIOA_BASE+GPIOA_ODR // set bit 5 to 1
          MOV R0, R1   // put duration into R0
          BL delay      // call delay function
    POP {PC}
